...
const styles = StyleSheet.create({
  ...
  panel: { width: '100%', maxWidth: 380, borderRadius: 0, borderWidth: BORDER_WIDTH_THICK, padding: 20, gap: 10, ...({ boxShadow: '6px 6px 0px #141414' } as const) },
  ...
  yearChip: { paddingHorizontal: 12, height: 38, borderRadius: 0, borderWidth: BORDER_WIDTH, alignItems: 'center', justifyContent: 'center' },
  yearText: { fontFamily: FONTS.monoBold, fontSize: 14 },
  monthGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  monthChip: { width: '22%', flexGrow: 1, height: 42, borderRadius: 0, borderWidth: BORDER_WIDTH, alignItems: 'center', justifyContent: 'center' },
  monthText: { fontFamily: FONTS.uiSemiBold, fontSize: 14 },
  actions: { flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 12 },
  cancelBtn: { flex: 1, height: 52, borderRadius: 0, borderWidth: BORDER_WIDTH, alignItems: 'center', justifyContent: 'center' },
  cancelText: { fontFamily: FONTS.uiBold, fontSize: 14, letterSpacing: 0.8 },
  confirmWrap: { flex: 1 },
  confirmBtn: { minHeight: 52, borderRadius: 0, borderWidth: BORDER_WIDTH_THICK, borderColor: '#141414', alignItems: 'center', justifyContent: 'center' },
