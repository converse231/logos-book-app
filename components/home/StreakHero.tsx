...
const VARIANTS: Record<StreakVariant, VariantSpec> = {
  start:    { img: require('@/assets/streak-hero/start.png'),    tone: 'light', msg: 'Start your streak' },
  day1:     { img: require('@/assets/streak-hero/day1.png'),     tone: 'light', msg: 'Nice start!' },
  building: { img: require('@/assets/streak-hero/building.png'), tone: 'light', msg: "It's catching!" },
  week:     { img: require('@/assets/streak-hero/week.png'),     tone: 'light', msg: 'On a roll!' },
  month:    { img: require('@/assets/streak-hero/month.png'),    tone: 'dark',  msg: 'Unstoppable!' },
  hundred:  { img: require('@/assets/streak-hero/hundred.png'),  tone: 'dark',  msg: 'Incredible!' },
  legend:   { img: require('@/assets/streak-hero/legend.png'),   tone: 'dark',  msg: 'Legendary!' },
  atRisk:   { img: require('@/assets/streak-hero/atRisk.png'),   tone: 'dark',  msg: 'Save your streak!' },
  broken:   { img: require('@/assets/streak-hero/broken.png'),   tone: 'dark',  msg: 'Comeback time' },
  night:    { img: require('@/assets/streak-hero/night.png'),    tone: 'dark',  msg: "You're set for today" },
  nudge:        { img: require('@/assets/streak-hero/nudge.png'),        tone: 'light', msg: 'Keep it going!' },
  almostThere:  { img: require('@/assets/streak-hero/almostThere.png'),  tone: 'light', msg: 'So close!' },
  personalBest: { img: require('@/assets/streak-hero/personalBest.png'), tone: 'light', msg: 'Personal best!' },
  comebackWin:  { img: require('@/assets/streak-hero/comebackWin.png'),  tone: 'dark',  msg: 'Streak restored!' },
  earlyBird:    { img: require('@/assets/streak-hero/earlyBird.png'),    tone: 'light', msg: 'Early bird!' },
  ghost:        { img: require('@/assets/streak-hero/ghost.png'),        tone: 'dark',  msg: 'We miss you' },
  lastChance:   { img: require('@/assets/streak-hero/lastChance.png'),   tone: 'dark',  msg: 'Last chance!' },
  frozen:       { img: require('@/assets/streak-hero/frozen.png'),       tone: 'dark',  msg: 'Streak frozen' },
  perfectWeek:  { img: require('@/assets/streak-hero/perfectWeek.png'),  tone: 'dark',  msg: 'Perfect week!' },
  milestoneDay: { img: require('@/assets/streak-hero/milestoneDay.png'), tone: 'light', msg: 'Milestone!' },
};
