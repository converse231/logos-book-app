...
const SOLID: Partial<Record<string, Partial<Record<IconTint, number>>>> = {
  ...
  compass:          { accent: require('@/assets/ui-icons/compass-accent.webp') },
  ...
  flag:             { gold:   require('@/assets/ui-icons/flag-gold.webp'),
                      muted:  require('@/assets/ui-icons/flag-muted.webp') },
  ...
  'phone-portrait': { accent: require('@/assets/ui-icons/phone-portrait-accent.webp') },
  ...
  sunny:            { accent: require('@/assets/ui-icons/sunny-accent.webp') },
  'tablet-portrait': { accent: require('@/assets/ui-icons/tablet-portrait-accent.webp') },
