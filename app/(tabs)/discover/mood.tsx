...
// Mood Reader (B6) — its own page, reached from the Discover hub banner. Describe
// a vibe or just browse, then swipe through AI picks. Right = Want shelf, left =
// pass, tap = preview. Server returns 10/req (token-cheap, 7-day cached).
