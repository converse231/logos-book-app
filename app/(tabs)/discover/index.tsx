...
const styles = StyleSheet.create({
  ...
  glyph: { width: 72, height: 72, borderRadius: 0, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
  ...
  previewIcon: { width: 44, height: 44, borderRadius: 0, alignItems: 'center', justifyContent: 'center' },
