...
const styles = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 16, height: 40, borderRadius: 0, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
  ...
  switch: { width: 46, height: 28, borderRadius: 0, padding: 3, justifyContent: 'center' },
  knob: { width: 22, height: 22, borderRadius: 0 },
  footer: { flexDirection: 'row', gap: 12, marginTop: 8, alignItems: 'center' },
  resetBtn: { height: 52, paddingHorizontal: 22, borderRadius: 0, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
