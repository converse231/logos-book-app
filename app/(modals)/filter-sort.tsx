...
const styles = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 16, height: 40, borderRadius: 999, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
  ...
  resetBtn: { height: 52, paddingHorizontal: 22, borderRadius: 16, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
